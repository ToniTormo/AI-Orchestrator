...
Contains implementation prompt for frontend development agent
"""

from typing import Dict, Any, List

def get_implementation_prompt_frontend(task: Dict[str, Any], context: Dict[str, Any]) -> str:
    """
    Generate the complete prompt for implementing client-side/frontend changes
    ...
    return f"""You are a frontend development specialist agent. Your role is to modify client-side code with precision. You understand modern frontend patterns, responsive design, and component architecture.
